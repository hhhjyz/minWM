...
keys = [
    ...
    "KV_COMPRESSION_DYNAMIC_ENABLE",
    "KV_COMPRESSION_DYNAMIC_MIN_KEEP",
    "KV_COMPRESSION_DYNAMIC_MAX_KEEP",
    "KV_COMPRESSION_DYNAMIC_TRANSLATION_SCALE",
    "KV_COMPRESSION_DYNAMIC_ROTATION_SCALE",
    "KV_COMPRESSION_DYNAMIC_MOTION_WEIGHT",
