...
export DATA_PATH="${DATA_PATH:-Wan21/prompts/viewbench_small12/prompts.txt}"
export TRAJECTORY_POSE_PATH="${TRAJECTORY_POSE_PATH-Wan21/prompts/viewbench_small12/trajectory_pose_paths.txt}"
export TRAJECTORY_PATH="${TRAJECTORY_PATH:-}"
export MAX_PROMPTS="${MAX_PROMPTS:-1}"
export PROMPT_START="${PROMPT_START:-0}"
export NUM_OUTPUT_FRAMES="${NUM_OUTPUT_FRAMES:-180}"
...
export OUTPUT_FOLDER="${OUTPUT_FOLDER:-./outputs/viewbench_small12_${PROMPT_START}_${MAX_PROMPTS}_${NUM_OUTPUT_FRAMES}}"
